...
export const services: ServiceDetail[] = [
  ...
  },
  {
    ...
    longDesc: "Cancer care at Shree Kalyan is built around the individual, not just the diagnosis. Our multidisciplinary tumor board ensures that every patient benefits from a collective expertise in surgical, medical, and radiation oncology. We utilize precision diagnostics to target the disease with surgical accuracy while preserving the patient’s quality of life.",
    services: [
      "Medical Oncology",
      "Surgical Oncology",
      "Chemotherapy Unit",
  ...
  },
  {
    ...
    longDesc: "When every second counts, vigilance is the ultimate medicine. Our Critical Care unit is the heart of the hospital’s trauma response, providing closed-unit intensive care where every patient is under the direct supervision of an expert intensivist. We utilize advanced electronic monitoring to ensure silent, constant protection.",
    services: [
      "Intensive Care (ICU)",
      "Trauma Center",
      "Emergency Medicine",
