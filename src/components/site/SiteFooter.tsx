      ...
      <div className="relative z-10 max-w-[1700px] mx-auto px-6 md:px-12 lg:px-24 py-24 md:py-40">
        <div className="grid grid-cols-12 gap-x-8 gap-y-20">
             ...
             <div className="flex flex-col md:flex-row md:items-end justify-between gap-12">
                <div className="max-w-3xl">
                  ...
                  <div className="flex flex-wrap gap-8 items-center">
                    ...
                    >
                      Get Directions <ArrowUpRight className="size-4 group-hover:translate-x-1 group-hover:-translate-y-1 transition-transform" />
                    </a>
                  </div>
                </div>
          ...
          <div className="col-span-6 md:col-span-3 lg:col-span-2">
            <p className="text-[0.65rem] tracking-[0.3em] uppercase text-paper/30 mb-10">Directory</p>
            <ul className="space-y-4 text-base font-light text-paper/80">
              ...
              <li><Link to="/team" className="hover:text-pink transition-colors">Physicians</Link></li>
          ...
          <div className="col-span-12 md:col-span-6 lg:col-span-3 lg:col-start-8">
            <p className="text-[0.65rem] tracking-[0.3em] uppercase text-paper/30 mb-10">Facility Hours</p>
            <div className="space-y-6">
              <div className="flex justify-between items-start border-b border-white/5 pb-4">
                <span className="text-sm font-light text-paper/60 uppercase tracking-widest">OPD · Mon–Sat</span>
