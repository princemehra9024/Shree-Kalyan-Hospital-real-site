...
export function Philosophy() {
  return (
    <section
      id="philosophy"
      className="px-6 md:px-12 lg:px-24 pb-16 md:pb-24 max-w-[1600px] mx-auto"
    >
      {/* ── Single bordered frame wrapping the entire section ── */}
      <div className="border border-ink/15 p-8 md:p-12 lg:p-16">
        <div className="grid grid-cols-12 gap-x-6 gap-y-12 items-center">

          {/* Left — chapter label + heading */}
