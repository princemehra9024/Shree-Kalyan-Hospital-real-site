...
function Index() {
  ...
  return (
    <div className="min-h-dvh bg-paper text-ink overflow-x-hidden">
      ...
      <main>
        {/* Hero */}
        <section className="relative pt-36 md:pt-44 pb-20 px-6 md:px-12 lg:px-24 max-w-[1600px] mx-auto">
          <div className="grid grid-cols-12 gap-x-6 items-center">
            <div className="col-span-12 lg:col-span-7 relative z-10">
              ...
              >
                ...
                <div className="overflow-hidden pt-4 pb-4 -mt-4">
                  <span className="block italic text-magenta font-normal ml-8 md:ml-32 mt-2 drop-shadow-sm">
                    vitality
                  </span>
                </div>
                <div className="overflow-hidden pt-4 pb-4 -mt-4">
              ...
              <div
                className="mt-12 md:mt-20 ml-2 md:ml-32 flex flex-col md:flex-row gap-12 md:gap-24 md:items-start"
                data-anim="hero-body"
              >
                <p className="text-lg md:text-xl max-w-[42ch] leading-[1.8] text-ink/70 text-pretty font-light">
                  We believe healing requires more than medical excellence. It demands a sanctuary
                  where advanced clinical practice meets profound human empathy.
                </p>
              ...
              >
                <div>
                  ...
                  <span className="text-[0.65rem] font-semibold uppercase tracking-widest text-ink/40 mt-2 block">
                    Specializations
                  </span>
                </div>
                <div>
            ...
            <div
              className="col-span-12 lg:col-span-4 lg:col-start-9 mt-20 lg:mt-0 relative"
          ...
          <div className="absolute bottom-10 left-1/2 -translate-x-1/2 hidden md:flex flex-col items-center gap-4 opacity-30 group">
            <span className="text-[0.6rem] font-bold tracking-[0.3em] uppercase rotate-90 origin-left ml-2 mb-8">
              Scroll
            </span>
