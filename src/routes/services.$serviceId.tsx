...
function ServiceIdPage() {
  ...
  return (
    <div className="min-h-dvh bg-paper text-ink overflow-x-hidden">
      ...
      <section className="px-6 md:px-12 lg:px-24 py-14 md:py-24 max-w-[1600px] mx-auto border-t border-ink/10">
      ...
      <section className="bg-navy-deep text-paper px-6 md:px-12 lg:px-24 py-16 md:py-24">
      ...
      {/* Facilities & Tech */}
      <section className="px-6 md:px-12 lg:px-24 py-16 md:py-24 max-w-[1600px] mx-auto">
