  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      gsap.fromTo(
        ".cg-eyebrow",
        { x: -70, opacity: 0 },
        { x: 0, opacity: 1, duration: 1.5, ease: "expo.out", delay: 0.1 },
      );
      gsap.fromTo(
        ".cg-sub",
        { y: 60, opacity: 0 },
      ...
      gsap.utils.toArray<HTMLElement>(".stage-card").forEach((card, i) => {
        ...
        gsap.fromTo(
          card.querySelector(".stage-inner"),
      ...
      gsap.utils.toArray<HTMLElement>(".tech-item").forEach((item) => {
        item.addEventListener("mouseenter", () => {
          ...
          gsap.to(item.querySelector(".tech-content"), {
            opacity: 1,
            y: 0,
            duration: 0.4,
            delay: 0.2,
      ...
      <section className="relative min-h-screen w-full grid lg:grid-cols-2 overflow-hidden">
        ...
        <div className="relative overflow-hidden cg-img-wrap order-1 lg:order-2 min-h-[50vh] lg:min-h-full">
          ...
          <div className="absolute top-8 right-8 z-10 flex flex-col items-center gap-2">
            ...
            <svg
              ref={ribbonRef}
              viewBox="0 0 80 100"
              className="w-20 h-24 drop-shadow-[0_0_20px_rgba(244,63,144,0.7)]"
              fill="none"
            >
              <path
              ...
              <circle
                ...
                strokeDasharray="1000"
                strokeDashoffset="1000"
                fill="rgba(244,63,144,0.2)"
              />
            </svg>
            <span className="text-[0.52rem] font-syne uppercase tracking-[0.3em] text-magenta/80 font-bold">
              Cancer Awareness
            </span>
          </div>
        </div>
        ...
        <div className="relative z-10 flex flex-col justify-end px-6 md:px-12 lg:px-20 pt-48 pb-16 md:pb-28 bg-paper order-2 lg:order-1">
          ...
          <p className="cg-sub max-w-md text-lg text-ink/60 font-light leading-relaxed mt-8 mb-10">
            We stand with you at every stage of your cancer journey. Our multidisciplinary oncology
            team brings global expertise with a deeply human approach to care.
          </p>

          <div className="flex flex-wrap gap-4">
            <a
              href="/appointments"
              className="mag-btn group bg-magenta text-white px-8 py-5 text-[0.65rem] font-syne font-bold uppercase tracking-widest hover:bg-navy-deep transition-colors duration-500 inline-flex items-center gap-3"
            >
              Book a Consultation
            ...
            <a
              href="/contact"
              className="mag-btn border border-navy/20 px-8 py-5 text-[0.65rem] font-syne font-bold uppercase tracking-widest text-ink/60 hover:border-navy hover:text-ink transition-all"
            >
              24/7 Support Line
            </a>
          </div>
      ...
      <section className="py-32 md:py-48 px-6 md:px-12 lg:px-24 max-w-[1600px] mx-auto">
        <div className="mb-20 grid md:grid-cols-2 gap-8 items-end">
          ...
          <p className="text-ink/55 text-lg font-light leading-relaxed max-w-sm md:ml-auto">
            Cancer treatment is never one-size-fits-all. Our four-stage pathway is designed to give
            you absolute clarity about what to expect at every turn.
          </p>
        </div>
            ...
            <div key={i} className="stage-card relative">
              ...
              <div className="stage-inner border border-navy/10 p-8 md:p-10 relative overflow-hidden group hover:-translate-y-1 transition-transform duration-500">
                ...
                <div className="flex items-center justify-between mb-6">
                  <span className="text-[0.58rem] font-syne uppercase tracking-[0.3em] text-magenta font-bold">
                    {s.num}
                  </span>
              ...
              >
                ...
                <div className="absolute bottom-6 md:bottom-10 left-6 md:left-10 z-10">
                  <div className="flex items-center gap-3 mb-3 md:mb-4">
                    <span className="text-[0.55rem] font-syne uppercase tracking-widest text-magenta font-bold">
                      0{i + 1}
                    </span>
                  </div>
                  <h3 className="font-display text-2xl md:text-4xl text-paper whitespace-nowrap drop-shadow-lg">
                    {tech.title}
                  </h3>
                </div>
        ...
        <div className="max-w-[1100px] mx-auto relative z-10 text-center">
          <div className="mb-12 flex justify-center">
            ...
            <svg viewBox="0 0 40 52" className="w-10 h-12" fill="none">
              <path
                d="M20 5 C9 5 5 16 5 23 C5 31 11 37 20 44 C29 37 35 31 35 23 C35 16 31 5 20 5Z"
                fill="rgba(244,63,144,0.15)"
                stroke="#f43f90"
                strokeWidth="1.5"
              />
              <path
                d="M20 44 C20 44 16 48 14 50 C18 49.5 20 47 20 47 C20 47 22 49.5 26 50 C24 48 20 44 20 44Z"
                fill="rgba(244,63,144,0.2)"
                stroke="#f43f90"
                strokeWidth="1.5"
              />
          ...
          <p className="font-display text-3xl md:text-5xl lg:text-[3.5rem] leading-[1.25] text-paper">
            {`"No patient should ever feel alone in their fight. We are your advocates, your shield, your steady hand through every storm."`
              .split(" ")
              .map((word, i) => (
                <span key={i} className="rw inline-block mr-[0.28em]">
                  {word}
                </span>
              ))}
          </p>
      ...
      <section className="cg-cta-split grid lg:grid-cols-2 min-h-[60vh]">
        ...
        <div className="cg-cta-r bg-magenta text-paper flex flex-col justify-center px-10 md:px-20 py-20 md:py-28">
          ...
          <p className="text-paper/75 font-light text-lg mb-12 max-w-sm leading-relaxed">
            Our oncology concierge team is available 24/7. Call us, write to us, or walk in — we are
            ready for you.
          </p>
