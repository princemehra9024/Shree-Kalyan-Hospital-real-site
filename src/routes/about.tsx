...
import { Building2, HeartPulse, Stethoscope, Users, CheckCircle2, ArrowDownRight, Award, ChevronRight } from "lucide-react";
...
export const Route = createFileRoute("/about")({
  ...
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Learn more about Shree Kalyan Hospital, our history, and our commitment to providing world-class healthcare in Kota, Rajasthan.",
      },
    ],
  }),
});
...
const TIMELINE = [
  { year: "2001", subtitle: "Genesis", title: "The Foundation", desc: "Shree Kalyan Hospital opens its doors as a specialized surgical center in Kota, Rajasthan — built on a single obsession: unhurried care." },
  { year: "2008", subtitle: "Innovation", title: "Technological Leap", desc: "Introduction of the first robotic-assisted surgery suite in the region, setting a new standard for precision and minimal-invasive procedures." },
  { year: "2015", subtitle: "Growth", title: "Regional Expansion", desc: "Expansion into a multi-specialty regional landmark with dedicated centres for Cardiology, Oncology, and state-of-the-art Neurosciences." },
  { year: "2024+", subtitle: "Future", title: "Legacy of Care", desc: "Celebrating over 1 million lives touched, consecutive NABH re-accreditations, and continuing our mission." }
];

const LEADERSHIP = [
  { img: doctor1, role: "Chief of Surgery", name: "Dr. Arvind Mehta", desc: "Over 30 years of excellence in minimally invasive and robotic surgical oncology." },
  { img: doctor2, role: "Head of Cardiology", name: "Dr. Sunita Sharma", desc: "Pioneer in complex angioplasties and advanced structural heart disease interventions." },
  { img: doctor3, role: "Chief Neurologist", name: "Dr. Vikram Singh", desc: "Internationally renowned for critical neuro-navigation and spinal reconstructive procedures." },
  { img: doctor4, role: "Medical Director", name: "Dr. Ananya Roy", desc: "Leading the global clinical governance and patient safety protocols across all facilities." }
];
...
function AboutPage() {
  ...
  useEffect(() => {
    let ctx = gsap.context(() => {
      ...
      timelineSteps.forEach((step) => {
        ...
        if (titleMask) {
          gsap.fromTo(titleMask,
            { yPercent: 120, skewY: 4, opacity: 0 },
            { 
              yPercent: 0, skewY: 0, opacity: 1, duration: 1.2, ease: "expo.out",
              scrollTrigger: {
                trigger: step,
                start: "top 80%",
                toggleActions: "play none none reverse"
  ...
  return (
    <div ref={pageRef} className="bg-paper text-ink font-sans pb-0 selection:bg-magenta selection:text-white overflow-hidden">
      <SiteNav />
        ...
        <div className="max-w-[1600px] mx-auto w-full relative z-10 grid grid-cols-12 gap-y-16 gap-x-8 items-center lg:items-end">
          ...
          <div className="col-span-12 lg:col-span-8 order-2 lg:order-1 relative z-20">
            <div className="mb-8 flex items-center gap-6" data-anim="hero-eyebrow">
              ...
              <span className="text-[0.65rem] font-syne uppercase tracking-[0.4em] font-bold text-navy-deep">Established 2001</span>
            </div>
            
            <h1 className="font-display text-navy-deep leading-[0.8] tracking-tighter mix-blend-multiply hero-massive-text" data-anim="hero-title">
            ...
            <div className="mt-16 max-w-xl pl-6 border-l-2 border-magenta relative" data-anim="hero-body">
              ...
              <p className="text-xl md:text-2xl text-ink/80 font-light leading-relaxed">
                Twenty-five years of quiet precision. Delivering world-class healthcare with an uncompromising, human touch right here in Kota.
              </p>
            </div>
            
            <div className="flex flex-wrap gap-12 lg:gap-20 mt-20 pt-10 border-t border-navy/10" data-reveal>
               <div className="flex flex-col">
                  <span className="font-display font-light text-4xl text-navy-deep">500<span className="text-magenta">+</span></span>
                  <span className="text-[0.55rem] font-syne uppercase tracking-widest text-ink/60 mt-3 font-bold">Beds Facility</span>
               </div>
               <div className="flex flex-col">
                  <span className="font-display font-light text-4xl text-navy-deep">140<span className="text-magenta">+</span></span>
                  <span className="text-[0.55rem] font-syne uppercase tracking-widest text-ink/60 mt-3 font-bold">Top Specialists</span>
               </div>
               <div className="flex flex-col">
                  <span className="font-display font-light text-4xl text-navy-deep">1M<span className="text-magenta">+</span></span>
                  <span className="text-[0.55rem] font-syne uppercase tracking-widest text-ink/60 mt-3 font-bold">Lives Touched</span>
               </div>
            </div>
          </div>
          
          <div className="col-span-12 lg:col-span-4 order-1 lg:order-2 relative">
            <div className="relative aspect-[3/4] w-full max-w-[400px] mx-auto lg:ml-auto group hero-img-container" data-anim="hero-image">
              ...
              <div className="absolute -bottom-10 -left-6 md:-left-12 bg-navy-deep p-6 md:p-8 shadow-editorial z-30 max-w-[240px]" data-anim="hero-badge">
                <ArrowDownRight className="w-8 h-8 text-magenta mb-6" />
                <p className="font-display italic text-paper text-2xl leading-none mb-3">Shree Kalyan Campus</p>
                <p className="text-[0.6rem] font-syne uppercase tracking-[0.2em] text-paper/60 font-bold hidden sm:block">Kota, Rajasthan</p>
              </div>
            </div>
          </div>
        </div>
         ...
         <div className="flex whitespace-nowrap marquee-content w-[200%] items-center">
            ...
            {[1, 2].map((group) => (
              <div key={group} className="flex items-center gap-16 px-8 w-1/2 justify-around">
                <span className="font-display font-light italic text-3xl md:text-5xl flex items-center gap-6"><Award className="w-10 h-10"/> NABH Accredited</span>
                <span className="h-2 w-2 rounded-full bg-paper/50"></span>
                <span className="font-display font-light italic text-3xl md:text-5xl">ISO 9001:2015</span>
                <span className="h-2 w-2 rounded-full bg-paper/50"></span>
                <span className="font-display font-light italic text-3xl md:text-5xl">#1 Central India Healthcare</span>
                <span className="h-2 w-2 rounded-full bg-paper/50"></span>
              </div>
            ))}
         </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24 items-start relative">
          ...
          <div className="col-span-1 lg:col-span-5 relative" data-reveal>
             <div className="h-[600px] overflow-hidden group border border-navy/5 relative">
               <img src={founderDoctor} alt="Founder" className="w-full h-[120%] object-cover grayscale group-hover:grayscale-0 transition-all duration-[2s] absolute top-[-10%] founder-img" />
             </div>
             <div className="absolute top-8 -right-8 origin-bottom-right -rotate-90 hidden lg:block">
               <p className="text-[0.55rem] font-syne uppercase tracking-[0.4em] text-navy-deep font-bold mix-blend-multiply">Origin · 2001</p>
             </div>
          </div>
          ...
          <div className="col-span-1 lg:col-span-6 lg:col-start-7 lg:sticky lg:top-32" data-reveal>
            <div className="mb-12">
              ...
              <h2 className="font-display text-4xl md:text-6xl leading-[0.9] text-navy-deep">
                Pioneers of <br/><em className="italic font-light text-magenta">Empathy.</em>
              </h2>
            </div>

            <div className="space-y-6 text-ink/75 text-lg font-light leading-relaxed">
              <p>
                From a modest surgical center to a leading multi-specialty hospital, our journey has been driven by one core philosophy: the patient always comes first.
              </p>
              <p>
                When we opened our doors in 2001, we aimed to create a sanctuary of healing. We understood that modern healthcare requires advanced technology, but we also knew that true healing requires empathy, patience, and a human connection.
              </p>
              <p>
                Today, Shree Kalyan Hospital is recognized across Rajasthan and beyond for its specialized departments, from Robotic Surgery to Oncology, all operating under the same guiding principle of unhurried, personalized care.
              </p>
            </div>
          ...
          <div className="mb-24 flex items-end justify-between" data-reveal>
             <div>
               ...
               <h2 className="font-display text-5xl md:text-7xl lg:text-[6.5rem] leading-[0.9] text-paper">
                 Evolution of <br/><em className="italic font-light text-paper/60 hidden sm:inline">Excellence.</em>
              ...
              >
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 relative z-10">
                  ...
                  <div className="col-span-1 lg:col-span-3 flex flex-col justify-center lg:pr-10 pb-6 lg:pb-0 timeline-year-block">
                    <span className="font-display text-5xl lg:text-7xl text-magenta mb-3 origin-left tracking-tight">{item.year}</span>
                    <span className="text-[0.6rem] font-syne uppercase tracking-[0.25em] text-paper/40 font-bold">{item.subtitle}</span>
                  </div>
                  ...
                  <div className="col-span-1 lg:col-span-9 grid lg:grid-cols-2 gap-8 items-center lg:pl-16">
                    ...
                    <div className="timeline-title-mask overflow-hidden py-2" style={{ clipPath: "polygon(0 0, 100% 0, 100% 100%, 0% 100%)" }}>
                      <h3 className="font-display text-3xl md:text-5xl lg:text-5xl text-paper leading-[1.1] transform-gpu">{item.title}</h3>
                    </div>
        ...
        <div className="horizontal-slider flex items-center px-6 lg:px-24 h-full will-change-transform pt-10">
          ...
          <div className="w-[80vw] lg:w-[40vw] shrink-0 pr-12 lg:pr-24">
             <h2 className="font-display text-5xl md:text-7xl lg:text-[7rem] leading-[0.8] text-navy-deep shrink-0">
                Guiding <br/><em className="italic font-light text-magenta">Hands.</em>
             </h2>
             <p className="text-ink/60 mt-8 text-xl font-light w-full max-w-sm">Scroll to explore the leading minds driving clinical innovation at Shree Kalyan.</p>
          ...
          {LEADERSHIP.map((leader, i) => (
             <div key={i} className="w-[85vw] md:w-[60vw] lg:w-[35vw] h-[60vh] md:h-[70vh] shrink-0 mr-12 lg:mr-24 relative group border border-navy/10 overflow-hidden bg-white">
                <div className="absolute inset-0 z-10 bg-gradient-to-t from-navy-deep/90 via-navy-deep/20 to-transparent"></div>
                <img src={leader.img} alt={leader.name} className="w-full h-full object-cover grayscale opacity-90 transition-all duration-[2s] group-hover:grayscale-0 group-hover:scale-105" />
                ...
                <div className="absolute bottom-0 left-0 p-8 lg:p-12 z-20 w-full transform transition-transform duration-500 translate-y-4 group-hover:translate-y-0">
                  <p className="text-[0.65rem] font-syne uppercase tracking-[0.3em] font-bold text-magenta mb-3">{leader.role}</p>
      ...
      <section className="py-32 bg-navy-deep text-paper relative overflow-hidden">
        <div className="max-w-[1600px] mx-auto px-6 lg:px-24 relative z-10">
           <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 mb-20" data-reveal>
             <div className="col-span-1 lg:col-span-5 relative">
              ...
              <h2 className="font-display text-5xl md:text-7xl text-paper leading-[0.9] tracking-tight">
                Without <br/><em className="italic font-light text-paper/60">Compromise.</em>
              </h2>
             </div>
             ...
             <div className="col-span-1 lg:col-span-5 lg:col-start-7 self-end">
               <p className="text-paper/50 text-xl font-light leading-relaxed">
                 We do not believe in mass-produced healthcare. Every protocol, every technological investment, and every decision is measured against one standard: patient wellbeing.
               </p>
             </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8" data-reveal>
            {[
              { icon: <Stethoscope className="w-8 h-8"/>, title: "Expert Team", desc: "Our doctors are renowed leaders, bringing decades of compassionate experience." },
              { icon: <Building2 className="w-8 h-8"/>, title: "Modern Facility", desc: "Equipped with state-of-the-art diagnostic and surgical technology in a comforting environment." },
              { icon: <HeartPulse className="w-8 h-8"/>, title: "Patient First", desc: "Every decision is centered around the well-being and comfort of our patients." },
              { icon: <Users className="w-8 h-8"/>, title: "Community Care", desc: "We are dedicated to improving the overall health of the communities we serve." }
            ].map((feature, i) => (
              <div key={i} className="group border-t border-white/10 pt-8 pb-10 hover:border-magenta transition-colors duration-500">
                <div className="text-white/30 mb-8 group-hover:text-magenta transition-colors duration-500 flex items-center justify-between">
                  {feature.icon}
                  <span className="font-syne text-[0.6rem] tracking-[0.2em] opacity-30 font-bold group-hover:opacity-100 transition-opacity">0{i+1}</span>
                </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24 items-center border-b border-navy/10 pb-32">
          ...
          <div className="col-span-1 lg:col-span-5 space-y-10 order-2 lg:order-1" data-reveal>
            <div>
               ...
               <h2 className="font-display text-4xl md:text-5xl lg:text-6xl text-navy-deep leading-[0.9]">
                 Precision <br/><em className="italic font-light text-navy-deep/60">Suites.</em>
               </h2>
            </div>
            
            <p className="text-ink/70 text-xl leading-relaxed font-light">
              We leverage the latest in medical technology to ensure absolute clinical precision, minimize recovery times, and optimize outcomes for every patient.
            </p>
            ...
            <div className="grid gap-8 mt-12">
              {[
                ...
                <div key={i} className="flex flex-col gap-3 relative pb-6 border-b border-navy/10 group">
                   ...
                   <div className="flex items-start gap-4">
                     ...
                     <span className="text-navy-deep font-display font-light italic lg:not-italic lg:font-sans lg:font-normal text-xl lg:text-lg">{item}</span>
                   </div>
                </div>
              ))}
            </div>
          ...
          <div className="col-span-1 lg:col-span-7 order-1 lg:order-2" data-reveal>
            <div className="aspect-square lg:aspect-auto lg:h-[800px] w-full relative group">
               ...
               <img src={operatingTheatre} alt="Operating Theatre" className="w-full h-full object-cover grayscale transition-all duration-1000 group-hover:grayscale-0" />
               <div className="absolute top-8 left-8 bg-paper p-4 border border-navy/10 shadow-editorial z-10">
                  <span className="text-[0.55rem] font-syne uppercase tracking-widest text-navy-deep font-bold">Facility Cam</span>
               </div>
            </div>
          </div>
      ...
      <section className="relative py-40 bg-surface overflow-hidden manifesto-section pb-40">
         <div className="absolute inset-0 opacity-10">
             <img src={hospitalLobby} className="w-full h-[150%] object-cover grayscale manifesto-bg" style={{ top: "-25%" }} alt="bg"/>
         </div>
         <div className="max-w-[1200px] mx-auto px-6 lg:px-24 relative z-20 text-center" data-reveal>
            ...
            <h2 className="font-display text-4xl md:text-6xl lg:text-8xl text-paper leading-[1.1] mb-12">
               Your Life.<br/>Our <em className="italic font-light text-magenta">Masterpiece.</em>
            </h2>
            <p className="text-paper/60 text-xl md:text-2xl font-light max-w-2xl mx-auto leading-relaxed mb-16">
               Experience the pinnacle of medical excellence with unwavering compassion. The next chapter of your health begins here.
            </p>
